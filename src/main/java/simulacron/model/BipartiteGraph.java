...
//						+ Extinction.ExtinctionReport((BipartiteGraph)state, 10) + System.getProperty("line.separator"));
...
public static ArrayList<Strategy<? extends Steppable>> getExtinctionStrategies(String strategyType) {
	...
	try {
		...
		for (String strat: stratList) {
			Strategy<? extends Steppable> strategy = (Strategy<? extends Steppable>)BipartiteGraph.getStrategy(strat);
